...
Ce guide sert à repackager Argos sur un PC Windows après avoir récupéré la branche de release depuis le GitLab FRA.
...
```powershell
git switch <branche_de_release>
git pull <remote_gitlab> <branche_de_release>
```
