...
try:
    from scrap_francemarche_robuste import ScrapeConfig, build_resilient_session, generer_url, resilient_get
...
def run_benchmark(query: str, pages: int, base_delay_s: float) -> None:
    ...
    for page in range(1, pages + 1):
        ...
        html = resilient_get(url, sess, cfg)
        ...
        if html:
            ...
            empty += 1
            print(f"[KO] page={page} t={dt:.2f}s html vide (bloqué ou erreur)")
